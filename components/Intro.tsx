 ...
 * Scans for a conventional developer, throws a glitchy 404,
 * then reveals the portfolio.
 */
      ...
      >
        ...
        <div className="font-code relative w-[min(90vw,640px)] px-6">
          {phase === "scan" && (
            <div>
              <p className="text-sm text-muted">
                <span className="text-crimson">&gt;</span> scanning the network
                for a conventional developer
          ...
          {phase === "boot" && (
            <div className="text-center">
              <p className="text-sm text-muted">
                <span className="text-crimson">&gt;</span> loading AI research
                profile
                <span className="intro-caret">_</span>
              </p>

              <p className="mt-4 text-2xl font-bold text-gradient sm:text-3xl">
                {site.name.toUpperCase()} // AI ENGINEER
              </p>
            </div>
          )}
        </div>
